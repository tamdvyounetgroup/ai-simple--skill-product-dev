---
description: Tự audit project theo 14 nguyên tắc ai-simple-product-dev → điểm theo applicability + backlog tối ưu xếp hạng (chạy mỗi quý hoặc khi nghi hệ docs đang mục)
